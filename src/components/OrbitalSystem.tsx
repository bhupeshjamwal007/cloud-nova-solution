...
export default function OrbitalSystem() {
  ...
  return (
    <>
      <div className="relative w-full h-[450px] md:h-[600px] flex justify-center items-center mt-8">
        {/* Center Circle */}
        <div 
          className="absolute top-1/2 left-1/2 w-[80px] h-[80px] md:w-[120px] md:h-[120px] rounded-full bg-[radial-gradient(circle_at_center,#fff,#00e5ff)] flex justify-center items-center shadow-[0_0_30px_#00e5ff] md:shadow-[0_0_50px_#00e5ff] z-10 font-bold text-black"
          style={{ transform: "translate(-50%, -50%)" }}
        >
          <span className="text-center text-[10px] md:text-sm">CLOUD NOVA</span>
        </div>

        <div
          className="absolute top-1/2 left-1/2 border border-white/10 rounded-full w-[200px] h-[200px] md:w-[300px] md:h-[300px] pointer-events-none"
        ...
        >
          ...
          >
            <img src={asset("/assets/web.png")} alt="Web Dev" className="w-[45px] h-[45px] md:w-[70px] md:h-[70px] rounded-full object-cover border-2 border-[#00e5ff] shadow-[0_0_15px_rgba(0,229,255,0.5)] md:shadow-[0_0_20px_rgba(0,229,255,0.5)] group-hover:scale-125 group-hover:shadow-[0_0_30px_rgba(0,229,255,1)] md:group-hover:shadow-[0_0_40px_rgba(0,229,255,1)] transition-all" />
          </div>
        </div>

        <div
          className="absolute top-1/2 left-1/2 border border-white/10 rounded-full w-[300px] h-[300px] md:w-[450px] md:h-[450px] pointer-events-none"
        ...
        >
          ...
          >
            <img src={asset("/assets/app.png")} alt="App Dev" className="w-[45px] h-[45px] md:w-[70px] md:h-[70px] rounded-full object-cover border-2 border-[#00e5ff] shadow-[0_0_15px_rgba(0,229,255,0.5)] md:shadow-[0_0_20px_rgba(0,229,255,0.5)] group-hover:scale-125 group-hover:shadow-[0_0_30px_rgba(0,229,255,1)] md:group-hover:shadow-[0_0_40px_rgba(0,229,255,1)] transition-all" />
          </div>
        </div>

        <div
          className="absolute top-1/2 left-1/2 border border-white/10 rounded-full w-[400px] h-[400px] md:w-[600px] md:h-[600px] pointer-events-none"
        ...
        >
          ...
          >
            <img src={asset("/assets/software.png")} alt="Software Dev" className="w-[45px] h-[45px] md:w-[70px] md:h-[70px] rounded-full object-cover border-2 border-[#00e5ff] shadow-[0_0_15px_rgba(0,229,255,0.5)] md:shadow-[0_0_20px_rgba(0,229,255,0.5)] group-hover:scale-125 group-hover:shadow-[0_0_30px_rgba(0,229,255,1)] md:group-hover:shadow-[0_0_40px_rgba(0,229,255,1)] transition-all" />
          </div>
        </div>
      </div>
